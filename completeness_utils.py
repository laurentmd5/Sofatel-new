"""Intervention completeness (simple scoring) - top-level utility to avoid package conflicts

This mirrors logic previously added under utils/completeness.py but placed at repo root to avoid name shadowing with the existing `utils.py` module.
"""
